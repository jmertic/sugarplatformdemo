...
<ul id="detail_header_action_menu" class="clickMenu fancymenu" name ><li class="sugar_action_button" >{if $bean->aclAccess("edit")}<input title="{$APP.LBL_EDIT_BUTTON_TITLE}" accessKey="{$APP.LBL_EDIT_BUTTON_KEY}" class="button primary" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='pos_Speakers'; _form.return_action.value='DetailView'; _form.return_id.value='{$id}'; _form.action.value='EditView';SUGAR.ajaxUI.submitForm(_form);" type="button" name="Edit" id="edit_button" value="{$APP.LBL_EDIT_BUTTON_LABEL}">{/if} <ul id class="subnav" ><li>{if $bean->aclAccess("edit")}<input title="{$APP.LBL_DUPLICATE_BUTTON_TITLE}" accessKey="{$APP.LBL_DUPLICATE_BUTTON_KEY}" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='pos_Speakers'; _form.return_action.value='DetailView'; _form.isDuplicate.value=true; _form.action.value='EditView'; _form.return_id.value='{$id}';SUGAR.ajaxUI.submitForm(_form);" type="button" name="Duplicate" value="{$APP.LBL_DUPLICATE_BUTTON_LABEL}" id="duplicate_button">{/if} </li><li>{if $bean->aclAccess("delete")}<input title="{$APP.LBL_DELETE_BUTTON_TITLE}" accessKey="{$APP.LBL_DELETE_BUTTON_KEY}" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='pos_Speakers'; _form.return_action.value='ListView'; _form.action.value='Delete'; if(confirm('{$APP.NTC_DELETE_CONFIRMATION}')) SUGAR.ajaxUI.submitForm(_form);" type="submit" name="Delete" value="{$APP.LBL_DELETE_BUTTON_LABEL}" id="delete_button">{/if} </li><li>{if $bean->aclAccess("edit") && $bean->aclAccess("delete")}<input title="{$APP.LBL_DUP_MERGE}" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='pos_Speakers'; _form.return_action.value='DetailView'; _form.return_id.value='{$id}'; _form.action.value='Step1'; _form.module.value='MergeRecords';SUGAR.ajaxUI.submitForm(_form);" type="button" name="Merge" value="{$APP.LBL_DUP_MERGE}" id="merge_duplicate_button">{/if} </li><li>{if $bean->aclAccess("detail")}{if !empty($fields.id.value) && $isAuditEnabled}<input id="btn_view_change_log" title="{$APP.LNK_VIEW_CHANGE_LOG}" class="button" onclick='open_popup("Audit", "600", "400", "&record={$fields.id.value}&module_name=pos_Speakers", true, false,  {ldelim} "call_back_function":"set_return","form_name":"EditView","field_to_name_array":[] {rdelim} ); return false;' type="button" value="{$APP.LNK_VIEW_CHANGE_LOG}">{/if}{/if}</li></ul></li></ul>
</div>
</td>
...
<ul class="yui-nav">
<li><a id="tab0" href="javascript:void(0)"><em>{sugar_translate label='DEFAULT' module='pos_Speakers'}</em></a></li>
<li><a id="tab1" href="javascript:void(0)"><em>{sugar_translate label='LBL_DETAILVIEW_PANEL3' module='pos_Speakers'}</em></a></li>
</ul>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_NAME' module='pos_Speakers'}{/capture}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_OFFICE_PHONE' module='pos_Speakers'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_TITLE' module='pos_Speakers'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
<td width='37.5%'  >
...
{capture name="label" assign="label"}{sugar_translate label='LBL_MOBILE_PHONE' module='pos_Speakers'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
<td width='37.5%'  class="phone">
...
{capture name="label" assign="label"}{sugar_translate label='LBL_DEPARTMENT' module='pos_Speakers'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
<td width='37.5%'  >
...
{capture name="label" assign="label"}{sugar_translate label='LBL_HOME_PHONE' module='pos_Speakers'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
<td width='37.5%'  class="phone">
...
{capture name="label" assign="label"}{sugar_translate label='LBL_OTHER_PHONE' module='pos_Speakers'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
<td width='37.5%'  class="phone">
...
{capture name="label" assign="label"}{sugar_translate label='LBL_DATE_ENTERED' module='pos_Speakers'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
<td width='37.5%'  >
...
{capture name="label" assign="label"}{sugar_translate label='LBL_FAX_PHONE' module='pos_Speakers'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
<td width='37.5%'  class="phone">
...
{capture name="label" assign="label"}{sugar_translate label='LBL_DATE_MODIFIED' module='pos_Speakers'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
<td width='37.5%'  >
...
{capture name="label" assign="label"}{sugar_translate label='LBL_DO_NOT_CALL' module='pos_Speakers'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
<td width='37.5%'  >
...
{capture name="label" assign="label"}{sugar_translate label='LBL_ASSIGNED_TO_NAME' module='pos_Speakers'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
<td width='37.5%'  >
...
{capture name="label" assign="label"}{sugar_translate label='LBL_EMAIL_ADDRESS' module='pos_Speakers'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_PRIMARY_ADDRESS' module='pos_Speakers'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
<td width='37.5%'  >
...
{capture name="label" assign="label"}{sugar_translate label='LBL_ALT_ADDRESS' module='pos_Speakers'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
<td width='37.5%'  >
...
{capture name="label" assign="label"}{sugar_translate label='LBL_DESCRIPTION' module='pos_Speakers'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
<td width='37.5%' colspan='3' >
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.twitter_id.hidden}
{capture name="label" assign="label"}{sugar_translate label='LBL_TWITTER_ID' module='pos_Speakers'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
<td width='37.5%'  >
...
{if strlen($fields.twitter_id.value) <= 0}
{assign var="value" value=$fields.twitter_id.default_value }
{else}
{assign var="value" value=$fields.twitter_id.value }
{/if} 
<span class="sugar_field" id="{$fields.twitter_id.name}">{$fields.twitter_id.value}</span>
{/if}
</td>
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.joindin_id.hidden}
{capture name="label" assign="label"}{sugar_translate label='LBL_JOINDIN_ID' module='pos_Speakers'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
<td width='37.5%'  >
...
<span class="sugar_field" id="{$fields.joindin_id.name}">
{assign var="value" value=$fields.joindin_id.value }
{$value}
</span>
{/if}
</td>
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.twitter_widget.hidden}
{capture name="label" assign="label"}{sugar_translate label='LBL_TWITTER_WIDGET' module='pos_Speakers'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
<td width='37.5%'  >
...
<span class="sugar_field" id="{$fields.twitter_widget.name}"><p>{literal}</p>
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.joindin_profile.hidden}
{capture name="label" assign="label"}{sugar_translate label='LBL_JOINDIN_PROFILE' module='pos_Speakers'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
<td width='37.5%'  >
...
{capture name=getLink assign=link}{$fields.joindin_profile.value}{/capture}
{sugar_replace_vars subject='https://joind.in/user/view/[joindin_id]' assign='link'}
{if !empty($link) && $link != "http://" && $link != "https://"}
{capture name=getStart assign=linkStart}{$link|substr:0:7}{/capture}
<input type="hidden" class="sugar_field" id="{$fields.joindin_profile.name}" value="{if ( $linkStart != 'http://' || $linkStart != 'https:/' ) && $link}http://{/if}{$link}">
<iframe src="{if $linkStart != 'http://' && $linkStart != 'https:/' && $link}http://{/if}{$link}" title="{if $linkStart != 'http://' && $linkStart != 'https:/' && $link}http://{/if}{$link}" height="{$fields.joindin_profile.height}" width="100%"/></iframe>
{/if}
{/if}
</td>
</tr>
