<?php /* Smarty version 2.6.11, created on 2012-05-02 22:32:34
         compiled from include/ListView/ListViewGeneric.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getjspath', 'include/ListView/ListViewGeneric.tpl', 43, false),array('function', 'counter', 'include/ListView/ListViewGeneric.tpl', 119, false),array('function', 'sugar_translate', 'include/ListView/ListViewGeneric.tpl', 133, false),array('function', 'sugar_getimage', 'include/ListView/ListViewGeneric.tpl', 139, false),array('function', 'sugar_ajax_url', 'include/ListView/ListViewGeneric.tpl', 207, false),array('function', 'sugar_evalcolumn_old', 'include/ListView/ListViewGeneric.tpl', 210, false),array('function', 'sugar_field', 'include/ListView/ListViewGeneric.tpl', 212, false),array('modifier', 'replace', 'include/ListView/ListViewGeneric.tpl', 72, false),array('modifier', 'default', 'include/ListView/ListViewGeneric.tpl', 122, false),array('modifier', 'lower', 'include/ListView/ListViewGeneric.tpl', 125, false),array('modifier', 'upper', 'include/ListView/ListViewGeneric.tpl', 128, false),)), $this); ?>
...
&help_action=&key='><?php echo $this->_tpl_vars['APP']['LBL_CLICK_HERE']; ?>
                ...
                <p class="submsg">
                    <?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['APP']['MSG_EMPTY_LIST_VIEW_NO_RESULTS_SUBMSG'])) ? $this->_run_mod_handler('replace', true, $_tmp, "<item1>", $this->_tpl_vars['pageData']['bean']['moduleDir']) : smarty_modifier_replace($_tmp, "<item1>", $this->_tpl_vars['pageData']['bean']['moduleDir'])))) ? $this->_run_mod_handler('replace', true, $_tmp, "<item4>", $this->_tpl_vars['helpLink']) : smarty_modifier_replace($_tmp, "<item4>", $this->_tpl_vars['helpLink'])); ?>
