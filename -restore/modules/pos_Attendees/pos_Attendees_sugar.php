 ...
 * PLACE ANY CUSTOMIZATIONS IN pos_Attendees
 */

require_once('include/SugarObjects/templates/person/Person.php');

class pos_Attendees_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'pos_Attendees';
	var $object_name = 'pos_Attendees';
	var $table_name = 'pos_attendees';
	var $importable = true;
