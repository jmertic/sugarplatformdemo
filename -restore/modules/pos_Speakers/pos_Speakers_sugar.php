 ...
 * PLACE ANY CUSTOMIZATIONS IN pos_Speakers
 */

require_once('include/SugarObjects/templates/person/Person.php');

class pos_Speakers_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'pos_Speakers';
	var $object_name = 'pos_Speakers';
	var $table_name = 'pos_speakers';
