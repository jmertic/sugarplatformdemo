 ...
 * PLACE ANY CUSTOMIZATIONS IN pos_Sponsors
 */

require_once('include/SugarObjects/templates/company/Company.php');

class pos_Sponsors_sugar extends Company {
	var $new_schema = true;
	var $module_dir = 'pos_Sponsors';
	var $object_name = 'pos_Sponsors';
	var $table_name = 'pos_sponsors';
