 ...
 * PLACE ANY CUSTOMIZATIONS IN pos_SponsorContacts
 */

require_once('include/SugarObjects/templates/person/Person.php');

class pos_SponsorContacts_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'pos_SponsorContacts';
	var $object_name = 'pos_SponsorContacts';
	var $table_name = 'pos_sponsorcontacts';
	...
	var $disable_row_level_security = true ; // to ensure that modules created and deployed under CE will continue to function under team security if the instance is upgraded to PRO
		...
		var $email_addresses;
		function pos_SponsorContacts_sugar(){	
		parent::Person();
	}
